...
## Library descpripion
Extensive support for data filtering, with flexible structure for querying both RESTful APIs and oData APIs. Offers a wide choice of UI filter components with state management per filter instance. Hooks-based library.
