...
export const singleFilterInitialState = {
  propertyFilters: {},
...
export const filter = (state = singleFilterInitialState, action) => {
  switch (action.type) {
    ...
    case FILTER_OVERRIDE_FILTER_STATE: {
      ...
      const navigationPropertyFilters =
        ...
        singleFilterInitialState.navigationPropertyFilters;
      const functionFilters =
        filterState?.functionFilters ||
        singleFilterInitialState.functionFilters;
      ...
      return {
        propertyFilters:
          ...
          singleFilterInitialState.propertyFilters,
        navigationPropertyFilters,
        functionFilters,
      };
    }
